...
namespace AverbacaoService.Infrastructure.Migrations
{
    ...
    [Migration("20250515181437_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AverbacaoService.Domain.Averbacoes.Averbacao", b =>
                {
                    b.OwnsOne("AverbacaoService.Domain.Averbacoes.Formalizacao", "Formalizacao", b1 =>
                        {
                            b1.Property<Guid>("AverbacaoId")
                                .HasColumnType("uniqueidentifier");

                            b1.Property<int>("CodigoIntegracao")
                                .HasColumnType("INT")
                    ...
                    b.OwnsOne("AverbacaoService.Domain.shared.ValueObjects.Proposta", "Proposta", b1 =>
                        {
                            b1.Property<Guid>("AverbacaoId")
                                .HasColumnType("uniqueidentifier");
                            ...
                            b1.OwnsOne("AverbacaoService.Domain.shared.ValueObjects.Prazo", "Prazo", b2 =>
                                {
                            ...
                            b1.OwnsOne("AverbacaoService.Domain.shared.ValueObjects.Proponente", "Proponente", b2 =>
                                {
                                    b2.Property<Guid>("PropostaAverbacaoId")
                                        .HasColumnType("uniqueidentifier");
